...
const WhyIs = () => {
    return (
        <section className=" py-16 lg:py-36 lg:px-16 px-6 flex flex-col lg:flex-row gap-10 items-center relative bg-[#FEECFF]">
            ...
            <div className="w-full lg:w-2/3">
                <ul className="grid grid-flow-row lg:grid-cols-2 lg:grid-rows-2 gap-8 p-8 px-0">
