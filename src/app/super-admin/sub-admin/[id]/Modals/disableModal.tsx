...
const DisableModal: React.FC<DisableModalProps> = ({ isOpen, onClose, awaitSubmit }) => {
  return (
    <Modal
      isOpen={isOpen}
      ...
      <div className="space-y-4 font-montserrat">
        ...
        <div className="flex flex-col justify-center text-center gap-6 items-center">
          <h1 className="text-black text-2xl font-medium">
            Are you sure you want to disable/enable this admin?
          </h1>
          <p className="text-black text-base font-medium">
            You are about to disable/enable an admin. Click on the “confirm” button to
            proceed.
          </p>
          <div className="flex justify-start items-center gap-4">
            ...
            <button className="bg-[#1A183E] rounded-lg px-4 py-2 text-white font-semibold text-base" onClick={awaitSubmit}>
              Confirm
            </button>
          </div>
        </div>
