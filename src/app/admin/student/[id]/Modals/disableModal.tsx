...
// Define props types for StudentModal
    ...
    >
      ...
      <div className="space-y-4 font-montserrat">
        ...
        <div className="flex flex-col justify-center text-center gap-6 items-center">
          <h1 className="text-black text-2xl font-medium">Are you sure you want to disable the student?</h1>
          <p className="text-black text-base font-medium">You are about to disable a student. Click on the “confirm” button to proceed</p>
