...
import { getAllAssessments, getAssessmentById } from "@/store/slices/assessmentSlice";
      ...
      <section className="h-screen overflow-hidden font-montserrat flex bg-white py-5 px-5 gap-10">
        ...
        <main className="overflow-auto w-full space-y-8 h-full">
          <h1 style={{ color: secondaryColor }} className="flex gap-2 font-base items-center font-semibold">
            <span className="cursor-pointer" onClick={() => router.push("/admin/assessment")}>
              Assessment
            </span>
            <ChevronRight />
            <span className="cursor-pointer" onClick={() => router.push(`/admin/assessment/${params.id}`)}>
              View Assessment
            </span>
          </h1>
          ...
          <div className="flex gap-12 items-center">
            <div className="flex gap-2 items-center">
              <button onClick={() => router.push("/admin/assessment")} className="border-r border-[#7A7A7A]">
                <ArrowLeft style={{ color: secondaryColor }} className="inline-block  p-2 w-[50px] h-[50px]" />
              </button>
            </div>
