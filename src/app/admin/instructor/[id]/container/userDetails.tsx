  ...
  return (
    <section className="flex max-w-[80%] flex-col gap-12 font-montserrat">
      ...
      <div className="flex flex-col gap-8">
        ...
        {/* bio */}
        <div className="flex flex-col items-start text-base font-medium gap-2">
          <h3 className="text-[#9A9A9A]">Biography</h3>
          <p className="text-black max-w-lg">{data.data?.profile?.bio || "NIL"}</p>
        </div>
      </div>
