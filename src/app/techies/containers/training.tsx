...
const Training = () => {
    return (
        <section className="flex flex-col items-center py-24 px-6 lg:px-24">
            <div className="flex flex-col lg:flex-row gap-8 justify-between items-center w-full">
                ...
                <p className="text-center lg:text-right ">We support intermediate to advanced software <br />engineers to achieve their career advancement goals.</p>
            </div>
