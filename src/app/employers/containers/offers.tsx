...
const Offers = () => {
    return (
        <section className='flex flex-col gap-16 justify-center items-center bg-secondary text-white px-6 lg:px-24 py-36'>
            ...
            <div className=''>
                <ul className='grid lg:grid-cols-3 gap-16 px-6 lg:px-24'>
