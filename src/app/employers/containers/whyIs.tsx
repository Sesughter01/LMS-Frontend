...
const WhyIs = () => {
    return (
        <section className=" py-36 px-6 lg:px-24 flex flex-col lg:flex-row gap-10 items-center relative bg-[#FEECFF]">
            ...
            <div className="w-full lg:w-2/3">
                <ul className="grid lg:grid-cols-2 lg:grid-rows-2 gap-8 p-8 px-0">
