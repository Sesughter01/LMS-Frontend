...
import { updateUserProfile, updateUserAvatar ,updateUser} from '@/store/slices/authSlice';
...
const Page = () => {
  ...
  const [avatarPreview, setAvatarPreview] = useState<string | null>(authUser?.profile.avatarImageUrl || imgPfp.src);
  const [identificationFile, setIdentificationFile] = useState<File | null>(null);
  const [identificationNumber, setIdentificatioNumber] = useState<number | null>(authUser?.id || null);
  ...
  try{
   ...
   console.log("FORM DATA: ", formData)
      ...
      const avatarUrl = avatar && (await uploadService.UploadFiletoS3(formData1));
            ...
            <ul className="flex flex-col lg:flex-row gap-12 lg:gap-6">
              <li className="lg:w-1/4 h-fit shrink-0 py-8 px-4 border border-gray-200 rounded-lg">
                <section className="flex flex-col items-center gap-6">
                   ...
                   */}
                   <label htmlFor="avatar-upload" className="bg-secondary p-2 text-white rounded cursor-pointer">
                     Upload New Photo
                  </label>
                  <input type="file" id="avatar-upload" accept="image/*" hidden className="hidden" onChange={handleAvatarChange} />
                  <div className="flex flex-col gap-2 border border-gray-200 bg-gray-50 p-4 text-center rounded-lg">
                    <small className="text-gray-600">Upload a new avatar. Larger image will be resized automatically</small>
                    <small className="font-semibold">Maximum upload is 2MB</small>
                  </div>
                  <div className="flex gap-1 text-sm mt-8">
                    Member since: <b>{authUser?.createdAt || '20th August 2023'}</b>
                  </div>
                </section>
              </li>
              <li className="lg:w-3/4 shrink-0  lg:p-8  border border-gray-200 rounded-lg">
                ...
                <TabsContent value="personal Information" className="py-8 px-4">
                  <h2 className="text-2xl font-semibold leading-7 text-gray-900 mb-6">Personal Information</h2>
                    <Tabs defaultValue="login" className="w-full">
                      ...
                      <TabsContent value="login" className="py-8 px-4">
                        <form onSubmit={handleSubmit}>
                          <section className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3">
                              <label htmlFor="conf-pass" className="block text-sm font-medium leading-6 text-gray-900">
                                Confirm Password
                              </label>
                              <div className="mt-2">
                                <input
                      ...
                      <TabsContent value="user" className="py-8 px-4">
                        <form onSubmit={handleSubmit}>
                          ...
                          <div className="mt-6 flex items-center justify-end gap-x-6">
                            <button type="button" className="text-sm font-semibold leading-6 text-gray-900 border rounded-lg px-4 py-2">
                              Cancel
                            </button>
                            <button
                              type="submit"
                ...
                <TabsContent value="address" className="py-8 px-4">
                         <form onSubmit={handleSubmit}>
                            <header>
                               <h2 className='text-2xl font-semibold leading-7 text-gray-900 mb-6'>Address</h2>
                            </header>
                          <section className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                          
                            <div className="sm:col-span-8">
                              <label htmlFor="resaddress" className="block text-sm font-medium leading-6 text-gray-900">
                                Residential Address
                              </label>
                              <div className="mt-2">
                                <input
                            ...
                            <div className="sm:col-span-3">
                              <label htmlFor="country_of_res" className="block text-sm font-medium leading-6 text-gray-900">
                            ...
                            <div className="sm:col-span-3">
                              <label htmlFor="state_of_origin" className="block text-sm font-medium leading-6 text-gray-900">
                                State of Origin
                              </label>
                              <div className="mt-2">
                                <input
                            ...
                            <div className="sm:col-span-3">
                              <label htmlFor="local_govt" className="block text-sm font-medium leading-6 text-gray-900">
                                Local Government
                              </label>
                              <div className="mt-2">
                                <input
                ...
                <TabsContent value="education" className="py-8 px-4">
                    <form onSubmit={handleSubmit}>
                            <header>
                               <h2 className='text-2xl font-semibold leading-7 text-gray-900 mb-6'>Education</h2>
                            </header>
                          <section className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3">
                              <label htmlFor="year_of_grad" className="block text-sm font-medium leading-6 text-gray-900">
                                Year of Graduation
                              </label>
                              <div className="mt-2">
                                <input
                            ...
                            <div className="sm:col-span-3">
                              <label htmlFor="course_of_study" className="block text-sm font-medium leading-6 text-gray-900">
                                Course of Study
                              </label>
                              <div className="mt-2">
                                <input
