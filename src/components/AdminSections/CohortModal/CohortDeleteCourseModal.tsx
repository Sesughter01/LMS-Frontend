...
const CohortDeleteCourseModal: React.FC<DeleteModalProps> = ({ isOpen, onClose, awaitSubmit, secondaryColor }) => {
  useEffect(() => {
  ...
  return (
    <Modal
      ...
      contentLabel="Remove Cohort Course Modal"
    ...
    >
      ...
      <div className="space-y-4 font-montserrat">
        ...
        <div className="flex flex-col justify-center text-center gap-6 items-center">
          ...
          <p className="text-black text-base font-medium">Do you really want to remove this course?</p>
...
export default CohortDeleteCourseModal;
