...
const DeleteModal: React.FC<DeleteModalProps> = ({ isOpen, onClose, awaitSubmit, secondaryColor, isDeleting }) => {
  useEffect(() => {
  ...
  return (
    <Modal
      ...
      contentLabel="Delete Cohort Modal"
    ...
    >
      ...
      <div className="space-y-4 font-montserrat">
        ...
        <div className="flex flex-col justify-center text-center gap-6 items-center">
          ...
          <p className="text-black text-base font-medium">Do you really want to delete this cohort?</p>
          <div className="flex justify-start items-center gap-4">
            ...
            <button
              disabled={isDeleting}
              style={{ backgroundColor: secondaryColor, pointerEvents: isDeleting? "none": "auto" }}
