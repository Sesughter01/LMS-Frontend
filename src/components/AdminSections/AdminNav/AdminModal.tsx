...
const AdminModal: React.FC<AdminModalProps> = ({ isOpen, onClose, awaitSubmit, onUpdate, data, loading, closeAction, secondaryColor }) => {
  useEffect(() => {
  ...
  const handleNextClick = (e: React.FormEvent) => {
    ...
    const newErrors = {
      ...
      // adminType: adminType ? "" : "Admin type is required",
    };
    ...
    >
      ...
      <div className="space-y-4 max-h-[420px] font-montserrat">
        ...
        {/* <p className="text-[#7A7A7A] font-medium text-[15px]">
          New admins will gain access to the course creation, student list, and
          progress analytics.
        </p> */}
        ...
        <form className="flex flex-col gap-6">
          {/* <div className="flex items-center gap-2">
            <select
              name="adminType"
              onChange={(e) => onUpdate("adminType", e.target.value)}
              className="rounded-md bg-gray-300 pt-3 pl-1 pb-2 pr-5 border border-gray-300"
            >
            ...
            <p className="flex-1">
              You can select a super admin or an admin to invite to the
              platform.
            </p>
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="fname" style={{ color: secondaryColor }} className="text-sm font-medium ">
              First Name
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="lname" style={{ color: secondaryColor }} className="text-sm font-medium ">
              Last Name
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="email" style={{ color: secondaryColor }} className="text-sm font-medium ">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="number" style={{ color: secondaryColor }} className="text-sm font-medium ">
              Mobile number
            </label>
            <PhoneInput
              country={"ng"}
        ...
        {/* Add form or content for adding a new admin */}
      </div>
    </Modal>
  );
};
