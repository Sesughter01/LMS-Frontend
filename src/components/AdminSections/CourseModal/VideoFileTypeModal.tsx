...
// Define props types for VideoFileTypeModal
interface VideoFileTypeModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const VideoFileTypeModal: React.FC<VideoFileTypeModalProps> = ({
  isOpen,
  onClose,
  awaitSubmit,
  parentModalOpener
  ...
  const handleNextClick = async(e: React.FormEvent) => {
    ...
    const newErrors = {
      ...
      videoFile: data.videoFile ? "" : "A valid video file is required",
    ...
    const files = e.target.files;
      if (files && files.length > 0) {
        ...
        if (file.type.toLowerCase().startsWith("video/")) {
          ...
          setErrors((prevErrors) => ({
            ...prevErrors,
            videoFile: "A valid video file is required",
          }));
          e.target.value = null;
        }
    }
 ...
 async function handleFileUpload(){
  ...
  return (
    <Modal
      ...
      className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white p-8 w-full max-w-lg h-[97%]" // Tailwind CSS classes for styling
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              type="file"
              required
              placeholder="Browse or drag the video file here."
              className={`py-3 px-5 rounded-lg bg-white focus:outline-none w-full
                placeholder-gray-200::placeholder placeholder-opacity-75 border
                ${errors.videoFile ? "border-red-500" : "border-[#ACACAC]"}`}
              id="videoFile"
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-1">
                ...
                <textarea 
                    name="summary" id="summary" cols={30} 
                    rows={4} placeholder="Add a summary"
                    className={`py-3 px-5 rounded-lg bg-white focus:outline-none w-full
                    placeholder-gray-200::placeholder placeholder-opacity-75 border border-[#ACACAC]`} 
...
export default VideoFileTypeModal;
