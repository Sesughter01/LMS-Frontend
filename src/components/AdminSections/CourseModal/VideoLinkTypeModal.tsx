...
// Define props types for VideoLinkTypeModal
interface VideoLinkTypeModalProps {
  isOpen: boolean;
...
const VideoLinkTypeModal: React.FC<VideoLinkTypeModalProps> = ({
  isOpen,
  onClose,
  awaitSubmit,
  parentModalOpener
  ...
  const handleNextClick = (e: React.FormEvent) => {
    ...
    const newErrors = {
      ...
      videoLink: data.videoLink && validateURL(data.videoLink) ? "" : "Invalid video link",
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`py-3 px-5 rounded-lg bg-white focus:outline-none w-full
                placeholder-gray-200::placeholder placeholder-opacity-75 border
                ${errors.videoLink ? "border-red-500" : "border-[#ACACAC]"}`}
              id="videoLink"
              value={data.videoLink}
              onChange={(e) => onUpdate("videoLink", e.target.value)}
            />
            {data.videoLink === "" && errors.videoLink && (
              <div className="flex text-red-500 text-xs items-center">
                <svg
                  className="mr-2"
                  xmlns="http://www.w3.org/2000/svg"
...
export default VideoLinkTypeModal;
